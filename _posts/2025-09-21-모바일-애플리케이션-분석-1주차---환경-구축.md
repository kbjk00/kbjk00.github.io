...
![](/assets/img/2025-09-21-모바일-애플리케이션-분석-1주차---환경-구축/img_1.png)

다운로드를 한 후에는 모두 Next, Accept 를 누르면 된다.

※ 설치할 때 한글이 있으면 안된다. 필자는 한글 때문에 여러 고생을 했다.

![](/assets/img/2025-09-21-모바일-애플리케이션-분석-1주차---환경-구축/img_2.png)
...
![](/assets/img/2025-09-21-모바일-애플리케이션-분석-1주차---환경-구축/img_3.png)

그러면 다음과 같이 디바이스가 있다.

![](/assets/img/2025-09-21-모바일-애플리케이션-분석-1주차---환경-구축/img_4.png)

여기서 맨 오른쪽 점 세 개 아이콘을 누르고

View Details 를 눌러 버전을 확인할 수 있다.

![](/assets/img/2025-09-21-모바일-애플리케이션-분석-1주차---환경-구축/img_5.png)

나는 x86\_x64 버전을 사용하고 있는 것을 확인할 수 있다.

그럼 다시 말해서 나는 17.3.2 버전에 x86\_x64 아키텍처인 Frida 서버를 설치해야 한다.

이제 깃허브 사이트에 들어가보자.

<br>

![](/assets/img/2025-09-21-모바일-애플리케이션-분석-1주차---환경-구축/img_6.png)

다음과 같이 나오는데

나는 세 번째 줄 frida-clr-17.3.2-windows-x86\_64.dll.xz 를 설치하면 된다.
...
.\frida-server\: 1 file pushed, 0 skipped. 110.8 MB/s (65754112 bytes in 0.566s)
```
...
[Releases · skylot/jadx](https://github.com/skylot/jadx/releases)

<br>

![](/assets/img/2025-09-21-모바일-애플리케이션-분석-1주차---환경-구축/img_7.png)
